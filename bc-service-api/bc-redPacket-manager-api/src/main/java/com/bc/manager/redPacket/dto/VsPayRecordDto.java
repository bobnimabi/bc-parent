...
public class VsPayRecordDto extends Page implements Serializable {
    ...
    public void setStartTime(Long mills){
        this.startTime = LocalDateTime.ofEpochSecond(mills, 0, ZoneOffset.ofHours(8));
    }
    public void setEndTime(Long mills){
        this.endTime = LocalDateTime.ofEpochSecond(mills, 0, ZoneOffset.ofHours(8));
    }

    @ApiModelProperty(value = "清除几天前记录")
