...
import com.bc.service.redPacket.config.SpringContextUtil;
...
//    }
    ...
    public ResponseResult queryHtml() throws Exception {
        return packetServer.queryHtml(1L);
    }

    @ApiOperation("富文本H5：查看")
    @GetMapping("/queryHtmlH5")
    public ResponseResult queryHtmlH5() throws Exception {
        return packetServer.queryHtml(2L);
    }

    @ApiOperation("流水记录：查看最新10条")
    @GetMapping("/queryNewRecord")
    public ResponseResult queryNewRecord() throws Exception {
        return packetServer.queryNewRecord();
    }
    ...
    @GetMapping("/test")
    public String test(){
        RedPacketServer serviceProxy = SpringContextUtil.getBean(RedPacketServer.class);
        RedPacketController serviceProxy2 = SpringContextUtil.getBean(RedPacketController.class);
